...
| Модуль | Файлы | Покрытие тестами | Статус |
|--------|-------|------------------|--------|
| **Bot Commands** (26 шт.) | 26 файлов (580+ KB), 29 тест-файлов | **53.85%** (stmts), 54.9% (funcs) | ХОРОШО |
| **Bot Services** (28 шт.) | 28 файлов, 38 тест-файлов | **82.78%** (stmts), 74.09% (funcs) | ОТЛИЧНО |
...
### 2. Общее покрытие тестами

| Метрика | Значение | Порог |
|---------|----------|-------|
| Statements | 46.45% | 45% OK |
| Branches | 39.94% | 40% ГРАНИЦА |
| Functions | 50.32% | 50% OK |
| Lines | 46.55% | 45% OK |
| **Всего тестов** | **~3935** | — |
| Unit тестов | ~50 файлов | — |
| Integration тестов | 6 файлов | — |
| E2E тестов | 4 файла | — |
...
GAMIFICATION                           ████████████████░░░░   83%
MINI APP                               ████████████░░░░░░░░   60%
BOT COMMANDS (интеграция)              ██████████░░░░░░░░░░   50%
BOT SERVICES (тесты)                   █░░░░░░░░░░░░░░░░░░░    1%
```
...
|---------|---------|--------------|------------------|
| Тест покрытие (общее) | 46% | 70% | 85% |
| Bot Services покрытие | 82.78% | 85% | 90% |
| Количество тестов | 3935 | 5000+ | 7000+ |
