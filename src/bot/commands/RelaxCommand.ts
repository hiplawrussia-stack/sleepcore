...
🌬 <b>Дыхание</b> — 5 мин, быстрый эффект
💪 <b>PMR</b> — 15 мин, глубокое расслабление
🧘 <b>Сканирование</b> — 10 мин, осознанность
🏝 <b>Образы</b> — 10 мин, визуализация
🎲 <b>Шаффл</b> — 10 мин, от тревожных мыслей
${recommendation}
...
${technique.icon} <b>${technique.name}</b>
⏱ ${technique.duration} минут

<i>${technique.description}</i>
