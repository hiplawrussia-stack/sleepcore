 ...
 */
export type PhaseTransition = 'none' | 'crisis_approaching' | 'recovery_beginning' | 'relapse_warning' | 'breakthrough_imminent' | 'mood_shift' | 'stability_achieved';
/**
 ...
 */
export type SmoothingMethod = 'kalman' | 'ewma' | 'double_exponential' | 'triple_exponential' | 'moving_average';
/**
 ...
 */
export declare const DEFAULT_TEMPORAL_CONFIG: TemporalEngineConfig;
/**
 * Horizon to hours mapping
 */
export declare const HORIZON_HOURS: Record<PredictionHorizon, number>;
//# sourceMappingURL=ITemporalPrediction.d.ts.map