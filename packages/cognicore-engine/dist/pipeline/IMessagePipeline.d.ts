 ...
 * Message intents
 */
export type MessageIntent = 'greeting' | 'help_request' | 'emotional_disclosure' | 'crisis' | 'question' | 'reflection' | 'exercise_response' | 'feedback' | 'small_talk' | 'command' | 'unknown';
/**
 * Message topics for mental health context
 */
export type MessageTopic = 'digital_addiction' | 'anxiety' | 'depression' | 'stress' | 'relationships' | 'self_esteem' | 'sleep' | 'motivation' | 'general' | 'unknown';
/**
 * Extracted entity
 */
 ...
 * Emotion types
 */
export type EmotionType = 'joy' | 'sadness' | 'anger' | 'fear' | 'anxiety' | 'stress' | 'hope' | 'gratitude' | 'loneliness' | 'frustration' | 'shame' | 'guilt' | 'neutral';
/**
 ...
 * Risk indicators
 */
export type RiskIndicator = 'self_harm_mention' | 'suicidal_ideation' | 'hopelessness' | 'social_isolation' | 'substance_mention' | 'declining_mood' | 'crisis_keywords' | 'rapid_mood_change';
/**
 * Engagement metrics
 */
 ...
 * Response types
 */
export type ResponseType = 'acknowledgment' | 'empathetic_response' | 'intervention' | 'question' | 'information' | 'encouragement' | 'crisis_response' | 'exercise' | 'check_in';
/**
 * Response button
 */
 ...
 */
export declare const DEFAULT_PIPELINE_CONFIG: IPipelineConfig;
/**
 ...
 * Pipeline events
 */
export type PipelineEvent = 'message:received' | 'message:analyzed' | 'state:updated' | 'risk:detected' | 'crisis:detected' | 'intervention:selected' | 'intervention:delivered' | 'response:generated' | 'pipeline:completed' | 'pipeline:error';
/**
...
//# sourceMappingURL=IMessagePipeline.d.ts.map